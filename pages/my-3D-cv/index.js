...
export default function App() {
    ...
    function Frames({ images, q = new THREE.Quaternion(), p = new THREE.Vector3() ,pos}) {
        ...
        return (
            ...
            onClick={(e) => (e.stopPropagation(), setLocation(clicked.current === e.object ? '/my-3D-cv' : '/my-3D-cv/item/' + e.object.name))}
            onPointerMissed={() => setLocation('/my-3D-cv')}>
